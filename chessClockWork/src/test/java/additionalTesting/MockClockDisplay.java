...
/** An implementor of the interface {@link ClockDisplay ClockDisplay} with the fields that can be
 * modified by the interface methods beeing public.
 *
 * @author Dragonstb
 * @since 1.0;
 */
public final class MockClockDisplay implements ClockDisplay {
